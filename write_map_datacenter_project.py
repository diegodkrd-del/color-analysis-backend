...
html_content = """<div style="background-color: #0F172A; color: #F8FAFC; padding: 40px; font-family: 'Outfit', sans-serif; border-radius: 20px; max-width: 1150px; margin: 0 auto; box-shadow: 0 20px 50px rgba(0,0,0,0.5);">
    ...
    <div style="background: #1E293B; padding: 22px; border-radius: 14px; margin-bottom: 35px; border: 1px solid rgba(255,255,255,0.08);">
        ...
        <div style="width: 100%; height: 420px; border-radius: 12px; overflow: hidden; border: 2px solid rgba(16, 185, 129, 0.4); box-shadow: 0 10px 30px rgba(0,0,0,0.5);">
            <iframe 
                width="100%" 
                height="100%" 
                style="border:0;" 
    ...
    <h2 style="color: #34D399; font-size: 22px; text-transform: uppercase; margin-bottom: 15px; letter-spacing: 0.5px;">
...
for base_dir in paths_to_create:
    try:
        ...
        target_file = os.path.join(html_dir, "15_SOLIDÃO_GIGAWATT_AI_DATACENTER_GOOGLE_EARTH.html")
